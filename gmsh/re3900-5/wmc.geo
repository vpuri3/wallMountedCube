...
// inner top
Point(61) = { hh,height,  0,lc};
Point(62) = { hm,height, hm,lc};
Point(63) = {  0,height, hh,lc};
Point(64) = {-hm,height, hm,lc};
Point(65) = {-hh,height,  0,lc};
Point(66) = {-hm,height,-hm,lc};
Point(67) = {  0,height,-hh,lc};
Point(68) = { hm,height,-hm,lc};
